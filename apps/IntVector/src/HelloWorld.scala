...
object HelloIntCompiler extends IntVectorApplicationCompiler with HelloInt 
object HelloIntInterpreter extends IntVectorApplicationInterpreter with HelloInt 

trait HelloInt extends IntVectorApplication { 
  def main() = {
    println("hello world")    
