...
/*
      ...
      */
      ...
      "blah_blah" is (compiler, (SArray), MUnit, effect=write(0)) implements setter(0, "_data", quotedArg(1))
...
///*
      ...
      "cut" is (infix, MInt, Column) implements composite ${
        set_data($self, array_map[String, String](data($self), e => $self.cutHelper($1, e)))
        $self
      }
      // effect?
/*
